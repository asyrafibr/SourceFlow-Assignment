    ...
    return (
      <footer className={styles.footer}>
        <div className={styles.footerContainer}>
          ...
          <FooterLinkSection title="Explore" links={footerData.exploreLinks|| []} />
          <FooterLinkSection title="Sectors" links={footerData.sectorLinks|| []} />
          <FooterLinkSection title="Services" links={footerData.serviceLinks|| []} />
        </div>
      </footer>
    );
  }
